...
import 'package:biye/features/product/data/services/product_service.dart'; // Tu servicio de API

// ------------------------------------------------------------------
// ✅ WIDGET GLASSMORPHISM CARD (Actualizado para ProductModel)
// ------------------------------------------------------------------
class GlassmorphismCard extends StatelessWidget {
  // Ahora usamos el modelo real importado de la API
  ...
  Widget build(BuildContext context) {
    // Aseguramos que el precio sea un String válido para la UI
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Expanded(
                  child: Center(
                    // Mostramos la imagen del producto (URL de la API)
                    child: Container(
                      decoration: BoxDecoration(
                    ...
                    GestureDetector(
                      onTap: () {
                        ...
                        final cartItem = CartItem(
                          ...
                          price: product.price,
                          quantity: 1,
                          // Campos adicionales requeridos por CartItem si existen
        ...
        children: [
          ...
          Column(
            children: [
              ...
              Container(
                height:
                    AppBar().preferredSize.height * scaleFactor +
